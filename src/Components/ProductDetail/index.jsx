...
const ProductDetail = () => {
    ...
    return(
        <aside className={`${context.isProductDetailOpen ? 'translate-x-0' : 'translate-x-full'} product-detail flex-col fixed right-0 bg-amber-100 transform transition-transform duration-300 border border-fuchsia-950 rounded-lg overflow-y-scroll`}>
